  ...
  return (
    <Container>
      ...
      <div className="subdiv">
        <img height="31rem" src="assets/Notifications/phsycology.jpeg" alt="" />
        <div className="text">
          <p>Human Psychology Facts . Posted in a Space you might. Wed</p>
          <span> Why are some people always single? </span>
        </div>
       <div className="hover">
            <svg className="dots" width="24" height="24" viewBox="0 0 24 24">
            <path
      ...
      <div className="subdiv">
        ...
        <div className="mid">
            ...
            <p>Quora gets better when you follow Spaces. Find one that matches your interests </p>
        </div>
        <div className="hover">
            <svg className="dots" width="24" height="24" viewBox="0 0 24 24">
            <path
      ...
      <div className="subdiv">
        <img height="31rem" src="assets/Notifications/round.jpeg" alt="" />
       <div className="text">
          <p>Phsychology of Life. Posted in a Space you might line . Mon</p>
          <span> How do you recognize people with high intelligence</span>
        </div>  
        <div className="hover">
        <svg className="dots" width="24" height="24" viewBox="0 0 24 24">
          <path
