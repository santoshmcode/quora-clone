...
>>>>>>> 7268f242f04dfb011fa765d0dc64efb409c14ee3
const style = {
    position: "absolute",
    top: "50%",
    left: "50%",
  ...
  return (
    ...
    <div className="qNav">
      ...
      <div className="qNav_icons" >
            <NavLink to="/homemaincontainer" className={isActive =>
    "nav-link" + (isActive ? " selected" : "")
        ...
        <div className="qNav_icon">
           ...
           <NavLink to="/postpage" className={isActive =>
    "nav-link" + (isActive ? " selected" : "")
  }>
        <div className="qNav_icon">
            <div className="svgIcon">
          ...
          > */}
                        ...
                        {open2 ? (
                            ...
                            >
                                <Alert
                                    ...
                                    sx={{ width: "100%" }}
                                >
                                    This question needs more detail. Add more
                                    information to ask a clear question, written
            ...
            <h5>Share NavLink</h5> */}
                                    ...
                                    <div>
                                        <h3>Edit Topics</h3>
                                        <div>
                                            Make sure this question has the
                                            right topics:
                                            <br />
